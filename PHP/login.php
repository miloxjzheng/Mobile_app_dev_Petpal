...
if (mysqli_num_rows($result1) == 1){
	...
	echo "<p style=\"font-weight:200;\">You are logged in, Pet owner. Go to <a href=\"#petownerhome\" rel=\"external\" style=\"text-decoration: none !important; \"> Homepage</a></p>";
}
//chech if match to pet lover table
elseif (mysqli_num_rows($result2) == 1){
	$_SESSION['user'] = $EMAIL_ID;
	echo "<p style=\"font-weight:200;\">You are logged in, Pet lover. Go to <a href=\"#petloverhome\" rel=\"external\" style=\"text-decoration: none !important; \"> Homepage</a></p>";
}
